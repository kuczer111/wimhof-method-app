export const onboardingStrings = {
  ...
  onboarding: {
    hero: {
      ...
      subtitle:
        "Unlock your body's natural potential through breathing, cold exposure, and commitment.",
    },
    pillars: {
      title: 'Three Pillars',
      breathing: 'Breathing',
      breathingDesc:
        'Controlled hyperventilation to oxygenate your body and shift your chemistry.',
      cold: 'Cold Exposure',
      coldDesc:
        'Gradual cold training to strengthen your cardiovascular system and willpower.',
      mindset: 'Mindset',
