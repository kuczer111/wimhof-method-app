export const breathingStrings = {
  breathe: {
    ...
    presets: {
      beginner: {
        name: 'Beginner',
        description: '3 rounds · 30 breaths · slow',
      },
      standard: {
        name: 'Standard',
        description: '3 rounds · 30 breaths · medium',
      },
      deepPractice: {
        name: 'Deep Practice',
        description: '4 rounds · 40 breaths · medium',
      },
      morningActivation: {
        name: 'Morning Activation',
        description: '3 rounds · 30 breaths · fast',
      },
    },
    rounds: 'Rounds',
  ...
  guidedMode: {
    ...
    enhancedDebrief: {
      ...
      retentionExplanation:
        "Your retention time is how long you held your breath after exhaling. It's normal for this to increase with each round as your body becomes more saturated with oxygen.",
      firstRoundNote: (time: string) =>
        `Your first hold was ${time} — a great starting point! Most people see significant improvement within their first few sessions.`,
      improvementTip:
        'Tip: Consistency matters more than duration. Even 5-10 seconds of improvement over time shows your body is adapting.',
    },
  },
} as const;
